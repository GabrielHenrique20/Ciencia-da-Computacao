/*Refaça a Questão Quicksort $10$ do Trabalho Prático II - com lista duplamente encadeada. O nome do arquivo de log será matrícula\_quicksort2.txt.*/
...
int main()
{
    ...
    FILE *arquivo = fopen("775799_quicksort2.txt", "w");
    if (arquivo == NULL)
    {
