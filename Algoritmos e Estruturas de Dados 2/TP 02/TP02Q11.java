 ...
 * Counting Sort, fazendo com que a chave de pesquisa seja o atributo
 * captureRate. O nome do arquivo de log será matrícula_countingsort.txt.
 * 
 * 
 * 
...
public class TP02Q11 {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("775799_countingsort.txt"))) {
