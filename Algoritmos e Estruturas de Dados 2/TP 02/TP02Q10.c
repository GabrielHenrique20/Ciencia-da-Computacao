/*Repita a questão de Ordenação por Seleção, contudo, usando o algoritmo Quicksort, fazendo com que a chave de pesquisa seja o atributo generation.
...
int main()
{
    ...
    FILE *arquivo = fopen("775799_quicksort.txt", "w");
    if (arquivo == NULL)
    {
