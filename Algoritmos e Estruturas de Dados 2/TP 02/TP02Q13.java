 ...
 * Mergesort, fazendo com que a chave de pesquisa seja o atributo types. O nome
 * do arquivo de log será matrícula_mergesort.txt.
 * 
 * (Lembre-se: em caso de empate, o critério de ordenação deverá ser o nome do
 * Pokémon)
 */
        ...
        while (i < n1 && j < n2) {
            ...
            if (a1[i].getTypes().size() > 0 && a2[j].getTypes().size() > 0) {
                if ((a1[i].getTypes().get(0).compareTo(a2[j].getTypes().get(0)) < 0) ||
                        ((a1[i].getTypes().get(0).compareTo(a2[j].getTypes().get(0)) == 0)
                ...
                if (((a1[i].getTypes().get(0).compareTo(a2[j].getTypes().get(0))) < 0) ||
                        ((a1[i].getTypes().get(0).compareTo(a2[j].getTypes().get(0)) == 0)
                                && (a1[i].getTypes().get(1).compareTo(a2[j].getTypes().get(1)) < 0))
                        ||
                        ((a1[i].getTypes().get(0).compareTo(a2[j].getTypes().get(0)) == 0)
                                && ((a1[i].getTypes().get(1).compareTo(a2[j].getTypes().get(1)) == 0))
                                && (a1[i].getName().compareTo(a2[j].getName()) < 0))) {
...
public class TP02Q13 {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("775799_mergesort.txt"))) {
